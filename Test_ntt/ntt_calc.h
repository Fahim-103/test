...
typedef struct test_case_s {
    ...
    uint64_t   w_powers[1024]; // an array w^(nk), allocate_aligned_array(), calc_w()
    uint64_t   w_powers_con[1024]; //an array w'^(nk)
    uint64_t   w_inv_powers[1024]; //this is required,, calc_w_inv(),
    uint64_t   w_inv_powers_con[1024];
